...
class KinectSensorBridged(CameraSensor):
    ...
    def __init__(self, quality=Kinect2BridgedQuality.HD, frame='kinect2_rgb_optical_frame', topic_prefix=''):
       ...
       """
        ...
        self.topic_image_color = topic_prefix + '/rgb/image_raw'
        self.topic_image_depth = topic_prefix + '/depth_to_rgb/image_raw'
        self.topic_info_camera = topic_prefix + '/rgb/camera_info'
    ...
    def ir_intrinsics(self):
        """:obj:`CameraIntrinsics` : The camera intrinsics.
        """
